...
public class AutoCreateSpringBoot extends AbstractAutoCreate implements AutoCreate {
	...
	public AutoCreateSpringBoot(String packge, String dbPath){
	...
	public AutoCreateSpringBoot(String packge, String dbPath, String prefix, String separator){
		if(!Tools.isNullOrEmpty(packge)){
			config = new Config(packge);
		}
		if(!Tools.isNullOrEmpty(dbPath)){
